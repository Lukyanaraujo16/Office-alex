	...
	<ul class="navbar-nav">
		...
		<div class="dropdown-menu ml-5" role="menu" style="">
			<?php if ($permission['iptv']) { ?>
				<a class="dropdown-item" href="#" data-toggle="modal" data-target="#fast_test_iptv_modal">Teste IPTV</a>
			<?php }
			...
			if ($permission['codes']) { ?>
				<div class="dropdown-divider"></div>
				<a class="dropdown-item" href="#" data-toggle="modal" data-target="#fast_test_code_modal">Teste Código P2P</a>
			<?php } ?>
		</div>
	</ul>
	<!-- Right navbar links -->
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div>
					<p><strong>NÃO ALTERE O TEMPLANTE<a href="/template.php"></a></strong></p>
				</div>
			</div>
...
<div id="fast_test_code_modal" class="modal fade" tabindex="-1">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">Dados do teste Código P2P</h5>
				<button type="button" class="close" data-dismiss="modal">&times;</button>
			</div>
			<div class="modal-body">
				<textarea class="form-control modal-textarea-code" id="test_modal_code" rows="15" placeholder="Aguarde..."></textarea><br>
				<div>
					<p><strong>TESTE CODIGO P2P CLIADO COM SUCESSO<a href="/template.php"></a></strong></p>
				</div>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-secondary" data-dismiss="modal">Fechar</button>
