								...
								<div class="card-body pad">
									<div class="accordion" id="accordionExample">
										...
										<button class="btn btn-block btn-secondary text-left mb-3 templates" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="true" aria-controls="collapseThree">
											<h6>Template mensagem rápida Codigo P2P</h6>
											<i class="fal fa-arrow-alt-from-top"></i>
										</button>
							...
							<form autocomplete="off" action="#" method="post">
								...
								<div class="card-body pad">
									<div class="row col-lg-6 col-md-12">
										...
										<h4>Código IPTV</h4>
										<div class="col-12">
											<label>Selecione o pacote padrão para o gerador de teste de <i>Código P2P</i>.</label>
											<div class="form-group">
								...
								<div class="card-body pad">
									<div class="row">
										...
										<div class="col-lg-6 col-md-12">
											<div class="callout callout-info">
												<div class="col-md-12">
													<h5>Template de teste automático (Código P2P) <button type="button" class="btn btn-info btn-xs" data-toggle="modal" data-target="#modal-var-auto-testcode">Ver variáveis disponíveis</button></h5>
													<label>Assunto</label>
													<div class="form-group">
										...
										<div class="col-lg-6 col-md-12">
											<div class="callout callout-info">
												<div class="col-md-12">
													<h5>Template de clientes próximo do vencimento <button type="button" class="btn btn-info btn-xs" data-toggle="modal" data-target="#modal-var-expiring-message">Ver variveis disponíveis</button></h5>
													<label>Assunto</label>
													<div class="form-group">
										...
										<div class="col-12">
											...
											<div id="iptv_migration">
												...
												<div class="form-group iptvmigrationfee">
													...
													<p><small class="text-muted">Se ativado ser cobrado o valor proporcional aos dias restantes até o vencimento.</small></p>
												</div>
											</div>
						...
						<?php } elseif ($_GET['page'] == "tools") { ?>
							...
							<!-- <div class="card card-default">
								...
								<form autocomplete="off" action="#" method="post">
									<div class="card-body pad">
										<p class="text-sm mb-0">
											Clique no botão abaixo caso estejam ocorrendo erros na criaão ou listagem de clientes.
										</p>
										<br>
									</div>
									<div class="card-footer">
