										...
										<div class="row">
											...
											<div class="col-12 row">
												<?php if ($permission['iptv']) { ?>
													<div class="form-group col-md-4">
														<label>Preço por Ativo <small>(IPTV)</small></label>
														<div class="input-group mb-3">
															<div class="input-group-prepend">
																<span class="input-group-text"><i class="fas fa-dollar-sign"></i></span>
															</div>
												...
												if ($permission['codes']) { ?>
													<div class="form-group col-md-4">
														<label>Preço por Ativo <small>(Códigos P2P)</small></label>
														<div class="input-group mb-3">
															<div class="input-group-prepend">
																<span class="input-group-text"><i class="fas fa-dollar-sign"></i></span>
															</div>
												...
												if ($permission['codes']) { ?>
													<div class="form-group col-lg-4">
														<div class="custom-control custom-switch">
															...
															<label class="custom-control-label" for="switchcodes">Pode criar Cdigos P2P</label>
														</div>
													</div>
												<?php }
												if ($permission['binstream']) { ?>
									...
									<div class="col-lg-6 col-md-12">
										<div class="callout callout-info">
											<dl class="row">
												...
												<dt class="col-sm-6">Clientes Ativos <small>(IPTV)</small></dt>
												<dd class="col-sm-6 stats-active_clients_iptv"><i class="fad fa-spinner fa-spin"></i></dd>
												<dt class="col-sm-6">Clientes Ativos <small>(Código P2P)</small></dt>
