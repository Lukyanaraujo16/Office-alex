...
$hostname = OFFICE_CONFIG['shorten_url'];

// PDO connection to the database
$connection = new PDO('mysql:dbname=' . OFFICE_CONFIG['office_db']['database'] . ';host=' . OFFICE_CONFIG['office_db']['hostname'], OFFICE_CONFIG['office_db']['username'], OFFICE_CONFIG['office_db']['password']);
