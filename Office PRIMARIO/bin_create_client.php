...
if (isset($_POST['username']) && isset($_POST['password']) && isset($_POST['reseller_notes']) && isset($_POST['package'])) {
	...
	$email = (isset($_POST['email']) ? trim(purifyHTML($_POST['email'])) : '');
	...
	$data = [
		...
		'endTime' => gmdate("Y-m-d\TH:i:s\Z", strtotime('+1 months')),
		'productId' => $package,
	...
	if (addOrRemoveCredits($logged_user['id'], -1)) {
		...
		if ($new_client['id']) {
			...
			insertRegUserLog($logged_user['id'], $username, $password, '<b>Novo Cliente Binstream</b> | Pacote: ' . $package . ' | Créditos: <font color="green">' . $old_credits . '</font> > <font color="red">' . $now_credits . '</font> | Custo: 1 Crédito');
			...
			header('location: /p2p/clients/show/' . $new_client['id']);
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1>Criar Cliente P2P</h1>
						</div>
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="#">Home</a></li>
								<li class="breadcrumb-item"><a href="/p2p/clients">P2P</a></li>
