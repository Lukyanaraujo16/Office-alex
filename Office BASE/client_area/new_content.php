...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed text-sm <?php if (DarkMode(true)) {
                                                                                                          echo "dark-mode";
                                                                                                        } ?>">
  <div class="wrapper">
  ...
  <script type="text/javascript">
    $(function() {
      $.ajax({
        url: '/sys/clientApi.php?action=new_vods',
        method: 'GET',
        dataType: 'json'
