...
if (isset($_POST['username']) && isset($_POST['password']) && isset($_POST['reseller_notes']) && isset($_POST['bouquet'])) {
	...
	if (is_array($bouquet)) {
		...
		if (updateClient($client_id, $username, $password, $phone, $email, $reseller_notes, $bouquet, $max_connections, $exp_date)) {
			$result = insertRegUserLog($logged_user['id'], $client['username'], $client['password'], '<b>Cliente Editado</b>');
							...
							<div class="card-body">
								<div class="row col-lg-6">
									...
									<div class="form-group col-md-6">
										...
										<div class="input-group mb-3">
											<input type="tel" autocomplete="off" name="phone_number" id="phone_number" class="form-control phone_number" value="<?php echo $client['phone']; ?>">
										</div>
									</div>
									<div class="form-group col-md-6">
									...
									<div class="form-group col-md-6">
										...
										<div class="input-group mb-3">
											...
											<input type="number" <?php if (!isAdmin($logged_user) && !isPartner($logged_user)) {
																							echo 'readonly=""';
																						} ?> name="max_connections" id="max_connections" value="<?php echo $client['max_connections']; ?>" class="form-control">
										</div>
									</div>
